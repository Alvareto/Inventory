...
namespace Inventory.Controllers
{
	public class CategoriesController : Controller
	{
		...
		public CategoriesController()
		{
			...
			this.repository = new NHibernateRepository<Category>(context);
		}

		public CategoriesController(IUnitOfWorkFactory uowFactory, IRepository<Category> repository )
		{
		...
		public ViewResult Index(int? page, int? pageSize, string sortBy, bool? sortDesc )
		{
			...
			IQueryable<Category> query = repository.All();
		...
		public ActionResult Edit(Category entity)
		{
			if (ModelState.IsValid)
				using (IUnitOfWork uow = uowFactory.Create()) {
					Category original = repository.All().Single(x => x.Id == entity.Id);
